...
const ARTICLES = [
  {
    ...
    faq: [
      {
        q: "공사가 중단됐는데 약정한 전체 공사대금을 청구할 수는 없나요?",
        a: "도급계약이 중도에 해제·해지되면 약정 전체 대금이 아니라 ‘기성고 비율에 따른 대금’을 청구하게 됩니다. 이미 투입된 공사비와 앞으로 투입될 공사비를 합한 전체 비용 중 완성된 부분이 차지하는 비율을 약정 대금에 곱해 산정합니다. 외관상 70%처럼 보여도 마감·설비가 후반에 몰리면 기성고 비율은 더 낮게 나올 수 있습니다.",
      },
      {
        q: "기성고 감정은 어느 시점을 기준으로 하나요?",
        a: "법원은 ‘공사가 중단된 시점’을 기준으로, ‘당초 계약 내용(설계도서·내역서)’을 전제로 감정을 명합니다. 따라서 어느 시점에 공사가 중단됐는지, 그 시점의 시공 범위가 어디까지인지, 계약상 시공 기준이 무엇인지를 소송 초기에 증거로 고정해 두는 것이 결정적입니다.",
      },
      {
        q: "계약서에 없는 추가공사를 한 경우 그 대금도 같이 받을 수 있나요?",
        a: "추가공사대금은 기성고 감정과 별개의 쟁점입니다. ‘추가공사에 관한 합의가 있었는지’와 ‘그 대금에 관한 약정이 있었는지’를 따로 입증해야 합니다. 서면 합의가 없다면 변경 도면, 발주자의 지시 문자, 증액된 자재 발주 내역 등 간접 정황을 촘촘히 모아 두는 것이 중요합니다.",
      },
    ],
    body: [
