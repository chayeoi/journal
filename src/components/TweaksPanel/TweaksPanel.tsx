  ...
  return (
    ...
    >
      <div className={styles.header} onMouseDown={onDragStart}>
        <b>Tweaks</b>
        <button className={styles.closeBtn} aria-label="Close tweaks" onClick={dismiss}>
          ✕
        </button>
      </div>
  ...
  return (
    <div className={styles.row}>
      ...
      >
        ...
        />
        {options.map((o) => (
          <button key={o.value} type="button" className={styles.segBtn} role="radio" aria-checked={o.value === value}>
            {o.label}
          </button>
        ))}
      </div>
