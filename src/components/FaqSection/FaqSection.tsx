...
export default function FaqSection({ faq }: Props) {
  ...
  return (
    <section className="artfaq" aria-labelledby="artfaq-h">
      <h2 className="artfaq__eyebrow" id="artfaq-h">
        자주 묻는 질문
      </h2>
      <div className="artfaq__list">
        {faq.map((item, i) => (
          <details key={i} className="faqq" name="article-faq" open={i === 0}>
            <summary className="faqq__q">
              <span className="faqq__mark" aria-hidden="true">
                Q
              </span>
            ...
            <div className="faqq__a">
              <span className="faqq__mark faqq__mark--a" aria-hidden="true">
                A
              </span>
