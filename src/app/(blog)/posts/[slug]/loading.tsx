      ...
      <main className="wrap" id="article-main" aria-hidden="true">
        ...
        <header className="arthead">
          <div className="arthead__text">
            {/* 카테고리 라인 */}
            <div style={{ ...skel, width: "80px", height: "14px", marginBottom: "12px" }} />
            {/* 제목 2줄 */}
            <div style={{ ...skel, width: "85%", height: "36px", marginBottom: "10px" }} />
            <div style={{ ...skel, width: "65%", height: "36px", marginBottom: "16px" }} />
            {/* 메타 1줄 */}
            <div style={{ ...skel, width: "200px", height: "16px" }} />
          </div>
          <figure className="artcover" style={{ margin: 0 }}>
            <div style={{ ...skel, width: "100%", aspectRatio: "16/9", borderRadius: "8px" }} />
          </figure>
        </header>
